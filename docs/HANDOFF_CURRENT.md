...
- JavaScript: 680 exact lifecycle tests, 655 top-level tests; expected source result
  633 passed plus 47 reviewed skips, and expected candidate result 634 passed plus
  46 reviewed skips.
