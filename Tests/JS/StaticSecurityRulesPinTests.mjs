...
test("static scan manifest warning allowlist is exact, reviewed, and source-bound", async () => {
  ...
  const reviewedShellWarnings = [
    ...
    },
    {
      ...
      sourceSha256: "16bd8416da797f93b480d4c9ce2b3bfd063dcd9149585d4347c5c43f1608b02e"
    },
    {
      scan: "default",
      ...
      sourceSha256: "472b40181a0a16de18bfaef0e20d8631e7b373a7adc55cd5d71735109a5fe7df"
    }
  ];
  assert.deepEqual(
